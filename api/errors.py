...
class BadPasswordError(ApiException):

    def __init__(self, password, error_http_code=HttpCodes.BAD_REQUEST):
        super().__init__(error_msg=f"password {password} is not in a valid form", error_http_code=error_http_code)
